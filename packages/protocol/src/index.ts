...
/**
 * Wire contract shared by the daemon and reviewctl.
 *
 * Every schema here is the single definition of a shape that crosses the
 * network. The daemon parses inbound bodies with it and reviewctl parses
...
/**
 * Exit codes for `reviewctl wait`. The harness reads these instead of parsing
